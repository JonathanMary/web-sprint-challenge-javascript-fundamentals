...
// Answer: When we run myFunction();, there is a call to the nestedFunction at the end of it.
...
const zooAnimals = [
 ...
 function animalNames(data){
   ...
   function getNames(obj){
     let name = obj["animal_name"];
     let scientific = obj["scientific_name"];
     displayNames.push(`name: ${name}, scientific: ${scientific}`);
    }
    data.forEach(getNames);
    //console.log(displayNames); FOR TEST
    return displayNames;
  }
  //animalNames(zooAnimals); FOR TEST
 ...
 function CuboidMaker(obj) {
  ...
  //let cube = new CuboidMaker(4, 5, 6);  //FOR TEST
  //console.log(cube);
